...
func (r *UserRepository) ensureBuiltinPermissions(ctx context.Context, now time.Time) error {
	permissions := []domain.Permission{
		...
		{ID: "perm-component-credential-view", Code: "component.credential.view", Name: "查看凭证管理", Module: "component", Action: "credential_view", Description: "查看 Git 凭证列表"},
		{ID: "perm-component-credential-manage", Code: "component.credential.manage", Name: "管理凭证", Module: "component", Action: "credential_manage", Description: "新增编辑删除 Git 凭证与连接测试"},

...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/artifacts/release-order-metadata": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_interfaces_http.ReleaseOrderArtifactMetadataSummaryListResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/notification-sources/actions/test-webhook": {
            "post": {
        ...
        "/onboarding/sessions": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "接入模式及可选项目",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_interfaces_http.OnboardingCreateRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/internal_interfaces_http.OnboardingSessionResponse"
                        }
                    },
                    "403": {
                        "description": "Forbidden",
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_interfaces_http.OnboardingVersionRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/onboarding/sessions/{id}/draft": {
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "版本及非敏感草稿",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_interfaces_http.OnboardingDraftRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/onboarding/sessions/{id}/first-release": {
            "post": {
                "consumes": [
                    "application/json"
                ],
                ...
                "parameters": [
                    ...
                    {
                        "description": "版本、幂等键与标准发布请求",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_interfaces_http.OnboardingFirstReleaseRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/onboarding/sessions/{id}/inspect": {
            "post": {
                "produces": [
                    "application/json"
                ],
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_interfaces_http.OnboardingInspectionResponse"
                        }
                    },
                    "403": {
                        "description": "Forbidden",
        ...
        "/onboarding/sessions/{id}/steps/{step}/apply": {
            "post": {
                "consumes": [
                    "application/json"
                ],
                ...
                "parameters": [
                    ...
                    {
                        "description": "预期版本与幂等键",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_interfaces_http.OnboardingApplyRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/release-orders": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Concurrent batch no",
                        "name": "concurrent_batch_no",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Concurrent batch name",
        ...
        "/release-orders/batch-create": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Batch create release orders request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_interfaces_http.BatchCreateReleaseOrdersRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_interfaces_http.ReleaseOrderBatchCreateResponse"
                        }
                    },
                    "201": {
                        "description": "Created",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_interfaces_http.ReleaseOrderArtifactMetadataListResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_interfaces_http.RecordReleaseOrderArtifactMetadataRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_interfaces_http.ReleaseOrderArtifactMetadataDataResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        "gos_internal_application_usecase.OnboardingField": {
            "type": "object",
            "properties": {
                "builtin": {
                    "type": "boolean"
        ...
        "gos_internal_application_usecase.OnboardingInspection": {
            "type": "object",
            "properties": {
                "fields": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/gos_internal_application_usecase.OnboardingField"
                    }
                },
                "issues": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/gos_internal_domain_onboarding.Issue"
                    }
                },
                "rows": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/gos_internal_application_usecase.OnboardingParamRow"
                    }
                }
            }
        },
        "gos_internal_application_usecase.OnboardingParamRow": {
            "type": "object",
            "properties": {
                "candidates": {
                    "type": "array",
        ...
        "gos_internal_domain_onboarding.Check": {
            "type": "object",
            "properties": {
                "issues": {
                    "type": "array",
        ...
        "gos_internal_domain_onboarding.Draft": {
            "type": "object",
            "properties": {
                "approval_flow_id": {
                    "type": "string"
                ...
                "change_approval_flow": {
                    "description": "Existing application policies are preserved unless this explicit switch is set.",
                    "type": "boolean"
                },
                "ci_pipeline_id": {
                    "type": "string"
                ...
                "identity": {
                    "$ref": "#/definitions/gos_internal_domain_onboarding.Identity"
                },
                "params": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/gos_internal_domain_onboarding.Parameter"
                    }
                },
                "repo_url": {
                    "type": "string"
        ...
        "gos_internal_domain_onboarding.Identity": {
            "type": "object",
            "properties": {
                "description": {
                    "type": "string"
        ...
        "gos_internal_domain_onboarding.Issue": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "string"
        ...
        "gos_internal_domain_onboarding.Parameter": {
            "type": "object",
            "properties": {
                "fixed_value": {
                    "type": "string"
        ...
        "gos_internal_domain_onboarding.References": {
            "type": "object",
            "properties": {
                "application_id": {
                    "type": "string"
        ...
        "gos_internal_domain_onboarding.Session": {
            "type": "object",
            "properties": {
                "check": {
                    "$ref": "#/definitions/gos_internal_domain_onboarding.Check"
                },
                "created_at": {
                    "type": "string"
                },
                ...
                "draft": {
                    "$ref": "#/definitions/gos_internal_domain_onboarding.Draft"
                },
                "first_release_order_id": {
                    "type": "string"
                },
                "id": {
                    "type": "string"
                ...
                "refs": {
                    "$ref": "#/definitions/gos_internal_domain_onboarding.References"
                },
                "status": {
                    "type": "string"
                },
        ...
        "internal_interfaces_http.BatchCreateReleaseOrderFailureResponse": {
            "type": "object",
            "properties": {
                "error": {
                    "type": "string"
        ...
        "internal_interfaces_http.BatchCreateReleaseOrdersRequest": {
            "type": "object",
            "properties": {
                "orders": {
                    "type": "array",
        ...
        "internal_interfaces_http.OnboardingApplyRequest": {
            "type": "object",
            "properties": {
                "expected_version": {
                    "type": "integer"
        ...
        "internal_interfaces_http.OnboardingCreateRequest": {
            "type": "object",
            "properties": {
                "application_id": {
                    "type": "string"
        ...
        "internal_interfaces_http.OnboardingDraftRequest": {
            "type": "object",
            "properties": {
                "draft": {
                    "$ref": "#/definitions/gos_internal_domain_onboarding.Draft"
        ...
        "internal_interfaces_http.OnboardingFirstReleaseRequest": {
            "type": "object",
            "properties": {
                "expected_version": {
                    "type": "integer"
        ...
        "internal_interfaces_http.OnboardingInspectionResponse": {
            "type": "object",
            "properties": {
                "data": {
                    "$ref": "#/definitions/gos_internal_application_usecase.OnboardingInspection"
                }
            }
        },
        "internal_interfaces_http.OnboardingSessionResponse": {
            "type": "object",
            "properties": {
                "data": {
                    "$ref": "#/definitions/gos_internal_domain_onboarding.Session"
                }
            }
        },
        "internal_interfaces_http.OnboardingVersionRequest": {
            "type": "object",
            "properties": {
                "expected_version": {
                    "type": "integer"
        ...
        "internal_interfaces_http.RecordReleaseOrderArtifactMetadataRequest": {
            "type": "object",
            "properties": {
                "artifact_name": {
                    "type": "string"
        ...
        "internal_interfaces_http.ReleaseOrderArtifactMetadataDataResponse": {
            "type": "object",
            "properties": {
                "data": {
                    "$ref": "#/definitions/internal_interfaces_http.ReleaseOrderArtifactMetadataResponse"
                }
            }
        },
        "internal_interfaces_http.ReleaseOrderArtifactMetadataListResponse": {
            "type": "object",
            "properties": {
                "data": {
                    "type": "array",
        ...
        "internal_interfaces_http.ReleaseOrderArtifactMetadataResponse": {
            "type": "object",
            "properties": {
                "artifact_name": {
                    "type": "string"
        ...
        "internal_interfaces_http.ReleaseOrderArtifactMetadataSummaryListResponse": {
            "type": "object",
            "properties": {
                "data": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/internal_interfaces_http.ReleaseOrderArtifactMetadataSummaryResponse"
                    }
                },
                "page": {
                    "type": "integer"
        ...
        "internal_interfaces_http.ReleaseOrderArtifactMetadataSummaryResponse": {
            "type": "object",
            "properties": {
                "application_id": {
                    "type": "string"
        ...
        "internal_interfaces_http.ReleaseOrderBatchCreateResponse": {
            "type": "object",
            "properties": {
                "data": {
                    "type": "object",
                    "properties": {
                        "failures": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/internal_interfaces_http.BatchCreateReleaseOrderFailureResponse"
                            }
                        },
                        "orders": {
                            "type": "array",
        ...
        "internal_interfaces_http.ReleaseOrderDeploySnapshotResponse": {
            "type": "object",
            "properties": {
                "argocd_app_name": {
                    "type": "string"
        ...
        "internal_interfaces_http.ReleaseOrderResponse": {
            ...
            "properties": {
                ...
                "deploy_snapshots": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/internal_interfaces_http.ReleaseOrderDeploySnapshotResponse"
                    }
                },
                "env_code": {
                    "type": "string"
